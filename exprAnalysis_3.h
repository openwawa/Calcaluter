#ifndef __EXPRANALYSIS_3_H__
#define __EXPRANALYSIS_3_H__
#include <iostream>
#include <vector>
#include <deque>
#include <string>
/*
计算器表达式3.0版本，根据文法优化了代码的结构，使其更加优雅合理 、层次化
...
public:
    Lexer(string input) :dataFlow{ input } {}
...
public:
    ...
    float getExpression(int flag) { //expr->term rest    /*flag 用于判断迭代过程中的括号表达式（expr）的判断处理*/
...
public:
    ...
    void pushToken(Token t1) {
        tokenBuffer.push_back(t1);
    }
    const Token popToken(void) {
